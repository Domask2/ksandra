...
import { Layout, Menu, Button, Row, Col, Typography, Form, Input, notification } from 'antd';
...
const SignIn = () => {
    ...
    const openNotification = (placement: NotificationPlacement, message: string, desc: string) => {
        notification.error({
            message: message,
            description: desc,
            placement,
            ...
            .catch((err: any) => {
                if (err.response.data) {
                    if (err.response.data.errors.email) {
                        openNotification('top', 'Ошибка входа', 'Введенные данные не актуальны');
                    } else {
                        openNotification('top', 'Ошибка входа', err.response.data.errors);
                    }
                }
            });
    };
                ...
                <Content className="signin">
                    <Row gutter={[24, 0]} justify="space-around">
                        <Col xs={{ span: 24, offset: 0 }} lg={{ span: 6, offset: 2 }} md={{ span: 12 }}>
                            <Title className="mb-15">Вход</Title>
                            {/*<SignInGoogle />*/}
                            <Form
                                onFinish={onFinish}
                            ...
                            >
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Пожалуйста введите вашу пароль',
                                        },
                                    ]}
                                >
